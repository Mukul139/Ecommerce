...
// ignore: unused_element
  ProfileNotCompeleted profileNotCompeleted(User user) {
    return ProfileNotCompeleted(
      user,
    );
  }
}
...
mixin _$AuthState {
  ...
  Result when<Result extends Object>({
    ...
    @required Result emailNotVerified(User user),
    @required Result profileNotCompeleted(User user),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result initial(),
    ...
    Result emailNotVerified(User user),
    Result profileNotCompeleted(User user),
    @required Result orElse(),
  });
  @optionalTypeArgs
  Result map<Result extends Object>({
    ...
    @required Result profileNotCompeleted(ProfileNotCompeleted value),
  });
  @optionalTypeArgs
  Result maybeMap<Result extends Object>({
    ...
    Result profileNotCompeleted(ProfileNotCompeleted value),
    @required Result orElse(),
  });
}
...
class _$Initial implements Initial {
  ...
  Result when<Result extends Object>({
    ...
    assert(profileNotCompeleted != null);
    return initial();
  }
...
class _$EmailNotVerified implements EmailNotVerified {
  const _$EmailNotVerified(this.user) : assert(user != null);
...
abstract class $ProfileNotCompeletedCopyWith<$Res> {
  factory $ProfileNotCompeletedCopyWith(ProfileNotCompeleted value,
          $Res Function(ProfileNotCompeleted) then) =
      _$ProfileNotCompeletedCopyWithImpl<$Res>;
  $Res call({User user});

  $UserCopyWith<$Res> get user;
}

class _$ProfileNotCompeletedCopyWithImpl<$Res>
    extends _$AuthStateCopyWithImpl<$Res>
    implements $ProfileNotCompeletedCopyWith<$Res> {
  _$ProfileNotCompeletedCopyWithImpl(
      ProfileNotCompeleted _value, $Res Function(ProfileNotCompeleted) _then)
      : super(_value, (v) => _then(v as ProfileNotCompeleted));

  @override
  ProfileNotCompeleted get _value => super._value as ProfileNotCompeleted;

  @override
  $Res call({
    Object user = freezed,
  }) {
    return _then(ProfileNotCompeleted(
      user == freezed ? _value.user : user as User,
    ));
  }
...
class _$ProfileNotCompeleted implements ProfileNotCompeleted {
  const _$ProfileNotCompeleted(this.user) : assert(user != null);
  ...
  @override
  String toString() {
    return 'AuthState.profileNotCompeleted(user: $user)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is ProfileNotCompeleted &&
            (identical(other.user, user) ||
                const DeepCollectionEquality().equals(other.user, user)));
  }
  ...
  @override
  $ProfileNotCompeletedCopyWith<ProfileNotCompeleted> get copyWith =>
      _$ProfileNotCompeletedCopyWithImpl<ProfileNotCompeleted>(
          this, _$identity);
  ...
  Result when<Result extends Object>({
    ...
    assert(emailNotVerified != null);
    assert(profileNotCompeleted != null);
    return profileNotCompeleted(user);
  }
  ...
  Result map<Result extends Object>({
    ...
    assert(emailNotVerified != null);
    assert(profileNotCompeleted != null);
    return profileNotCompeleted(this);
  }
...
abstract class ProfileNotCompeleted implements AuthState {
  const factory ProfileNotCompeleted(User user) = _$ProfileNotCompeleted;
